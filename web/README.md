...
- **CSS** – Estilização das interfaces (`web/ui/style.css`, `web/login/style.css`)
- **JavaScript** – Funcionalidades e interatividade nas páginas

Essas linguagens foram usadas nas pastas `web`, `web/ui` e `web/login` para criar a interface do sistema TechMan.
